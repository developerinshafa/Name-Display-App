...
export default function CartItem({ item }) {
    ...
    return (
    <li className="grid justify-between items-center bg-blue-50 border-b-8 border-l-8 border-blue-950 inset-shadow-sm inset-shadow-blue-700 shadow-xl shadow-blue-700/50 px-4 py-2 rounded w-250">
    ...
    <div className="flex items-center space-x-14 bg-blue-200 text-black rounded font-semibold">
        <div className='space-x-2 p-2 '>
            <button className=' hover:bg-red-500 rounded-full text-xl px-2' 
